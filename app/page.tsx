...
export const metadata: Metadata = {
  title: "Web & Software Company in Noida",
  description: "Web and software development company in Noida for websites, ecommerce, apps, CRM, AI and SEO. Get a free consultation from Encogix.",
        ...
        <div className="container-page relative grid gap-12 md:grid-cols-2 items-center">
          <div className="space-y-6 fade-in-up">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-primary tracking-tight leading-tight">
              Website & software solutions that grow your business
              <br />
              <span className="bg-gradient-to-r from-secondary to-accent bg-clip-text text-transparent">apps, ecommerce & digital marketing.</span>
            </h1>
