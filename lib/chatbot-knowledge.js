...
const KNOWLEDGE = {
  ...
  ecommerce: {
    ...
    reply: 'Our ecommerce solutions include product catalogue, cart, checkout, Cashfree/payment gateway, order management, admin panel, and inventory support. Projects start at ₹75,000 and typically take 4–8 weeks.',
    hindi: 'Ecommerce solution mein product catalogue, cart, checkout, Cashfree/payment gateway, order management, admin panel aur inventory support milta hai. Projects ₹75,000 se start hote hain aur 4–8 weeks lagte hain.',
