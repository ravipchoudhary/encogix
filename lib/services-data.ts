...
export const SERVICES: Record<string, ServicePageData> = {
  ...
  "ecommerce-development": {
    ...
    metaDescription: "Ecommerce website development with cart, checkout, Cashfree payment gateway, order & inventory management. Noida & Delhi NCR. From ₹75,000.",
    ...
    features: ["Product listing & categories", "Shopping cart & checkout", "Cashfree payment gateway", "Order management system", "Inventory management", "Customer accounts", "Admin dashboard", "Mobile ecommerce UX"],
    ...
    icon: "cart",
    faqs: [
      { question: "Which payment gateways do you integrate?", answer: "We integrate Cashfree, PayU, and other popular Indian payment gateways." },
